...
dir.create(loop_dir)
LF_Tree_Loop <- loop_regression_tree(LF,fcol,lcol,bins,Nsplit,save_dir=loop_dir,max_select = 3) #  consider ont only the best split but the top 3 competing splits
```
